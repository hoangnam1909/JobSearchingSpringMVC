...
INSERT INTO `candidate` VALUES (1,7,'Ngu','Ngáo','Công nghệ thông tin','TOEIC 750','lmao',NULL,32),(6,10,'ngáo','ngu','Công nghệ thông tin','TOEIC 750','',NULL,41),(7,10,'ngáo + ngu','','Ngôn ngữ Anh','','',NULL,42),(8,100,'','già','','','',NULL,43),(10,NULL,'hài hước bro','ngu','','','',NULL,45),(12,18,'ngu','ko thông minh','Ăn chơi nhảy múa','','','',47),(13,46,'test update redirect to add','','','','',NULL,46),(14,12,'','','','','','https://res.cloudinary.com/dxorabap0/image/upload/v1651720441/bcbmad4jcuxgrarmsbmp.jpg',48),(15,19,'ngu','ko thông minh','','','','',52),(16,NULL,'','','','','','',57),(17,NULL,'','','','','','',60),(18,8,'Ngu','Khôn','Dược phẩm','IELTS 8.5','Không có','https://res.cloudinary.com/dxorabap0/image/upload/v1651817887/faldsrp4ofhonfeiygkn.jpg',63),(19,NULL,'','','','','','',79),(20,NULL,'','','','','','',80),(21,NULL,'','','','','','',81);
...
INSERT INTO `comment` VALUES (46,10,32,'test date','2022-05-07 00:00:00'),(49,10,32,'nhin ne','2022-05-07 01:03:20'),(51,10,32,'dungcho','2022-05-07 09:33:58'),(52,10,41,'ungvientest1 cmt nè','2022-05-07 13:03:26'),(53,10,41,'cmt tét','2022-05-07 13:04:27');
...
CREATE TABLE `employer` (
  ...
  `majoring` longtext COLLATE utf8mb4_unicode_520_ci,
  `user_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- Dump completed on 2022-05-07 13:21:46
